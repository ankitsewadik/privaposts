jQuery(document).ready(function() {
	...
	// jQuery(document).on('click', '.um-finish-upload.image.notusednow:not(.disabled)', function(){
		
	// 	var elem = jQuery(this);
	// 	var key = jQuery(this).attr('data-key');
	// 	var img_c = jQuery(this).parents('.um-modal-body').find('.um-single-image-preview');
	// 	var div_h = img_c.find('.croppie-container').find('img');
	// 	var src = div_h.find('img').attr('src');
