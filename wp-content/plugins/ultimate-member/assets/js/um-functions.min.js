...
function initCrop_UM_New() {
    $('.image_square').croppie('destroy');
    $('.image_cover').croppie('destroy');
    $('.cr-boundary').hide();
    $('.cr-slider-wrap').hide();
    //$(".croppie-container").find('.cropper-container').remove(); 
    $('.image_square').each(function(index) {
        //console.log( index + ": " + $( this ).text() );
        if ($(this).attr('src') != '') {
            //$( this ).remove();
            $(this).addClass('sqrImgexist');
            // image cropper for profile
            var mc = $('.sqrImgexist');
            var width = $("#um_upload_single").width();
            var height = $("#um_upload_single").height();
            ...
            $('.um-finish-upload').on('click', function(ev) {
                ...
                mc.croppie('result', {
                	...
                	var user_id = 0;
					if ( jQuery('#um_upload_single').data('user_id') ) {
						user_id = jQuery('#um_upload_single').data('user_id');
					}	
um_modal_responsive();
                    jQuery.ajax({
							url: wp.ajax.settings.url,
    ...
    $('.image_cover').each(function(index) {
        //console.log( index + ": " + $( this ).text() );
        if ($(this).attr('src') != '') {
            //$( this ).remove();
            var width = $("#um_upload_single").width();
            ...
            $(this).addClass('coverImgexist');
            var mc_sqr = $('.coverImgexist');
    ...
    $(".cncelImg").click(function(){
		jQuery(".cncelImg").hide();
		jQuery(".um-finish-upload").hide();
		var parent = jQuery(".um-single-image-preview").parents('.um-modal-body');
		var src = jQuery(".um-single-image-preview").parents('.um-modal-body').find('.um-single-image-preview img').attr('src');
	...
	if ( target_img.length ) {
		...
		if ( target_img.attr('src') != '' ) {
			...
			if ( jQuery(window).height() <= 400 ) {
				...
				target_img_parent.css({ 'height': '400px', 'max-height' : max_height + 'px' });
			}
			...
			if ( crop_data != 0 ) {
					$('.slider-horizontal').css("width",'30%');
        ...
        switch(e.keyCode)
            ...
            break;
				...
				$(".cncelImg").click(function(){
						 ...
						 target_img.cropper("destroy");
						 $(".zoomfeature").hide();
						 $(".cncelImg").hide();
						 $(".um-finish-upload").hide();
...
function um_modal_responsive_new() {
