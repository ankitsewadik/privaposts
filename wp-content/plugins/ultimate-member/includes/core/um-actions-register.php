...
function um_add_submit_button_to_register( $args ) {
	...
	<div class="um-col-alt">
		...
		<?php } else { ?>
			...
			<div class="um-center"><input type="submit" disabled value="<?php echo __( $primary_btn_word,'ultimate-member'); ?>" class="btn btn-theme-sm signupbtn" id="um-signupbtn-btn" /></div>
