...
function um_add_submit_button_to_login( $args ) {
	...
	<div class="um-col-alt">
		...
		<?php if ( isset( $args['show_rememberme'] ) && $args['show_rememberme'] ) {
			//echo UM()->fields()->checkbox('rememberme', __('Remember Me','ultimate-member') );
        ...
        <a class="btn-text" href="#" data-toggle="modal" data-target="#reset_password_myModal">Forgot Password?</a> </div>

           
		<?php if ( isset($args['secondary_btn']) && $args['secondary_btn'] != 0 ) { ?>

			<div class="um-left um-half"><input type="submit" value="<?php echo __( $primary_btn_word,'ultimate-member'); ?>" class="btn btn-theme-sm" id="um-submit-btn" /></div>
		...
		<?php } else { ?>
			...
			<div class="um-center"><input type="submit" value="<?php echo __( $args['primary_btn_word'],'ultimate-member'); ?>" class="btn btn-theme-sm" id="um-submit-btn" /></div>
