		...
		function edit_field( $key, $data, $rule = false, $args = array() ) {
			...
			switch ( $type ) {
				...
				case 'text':
					...
					$output .= '<div class="form-group um-field-area">';

					$output .= '<span class="input-icon"><i class="fa"><img src="'.get_template_directory_uri().'/assets/images/'. $icon.'.png" alt=""></i></span>';
					...
					$output .= '<input ' . $disabled . ' autocomplete="' . $autocomplete . '" class="form-control ' . $this->get_class( $key, $data ) . '" type="' . $input . '" name="' . $field_name . '" id="' . $field_name . '" value="' . $field_value . '" placeholder="' . $placeholder . '" data-validate="' . $validate . '" data-key="' . $key . '" />
				...
				case 'password':
					...
					if ($key == 'single_user_password') {
						...
						$output .= '<input class="form-control ' . $this->get_class( $key, $data ) . '" type="' . $input . '" name="' . $key . UM()->form()->form_suffix . '" id="' . $key . UM()->form()->form_suffix . '" value="' . $this->field_value( $key, $default, $data ) . '" placeholder="' . $placeholder . '" data-validate="' . $validate . '" data-key="' . $key . '" />
						...
						if ($this->set_mode == 'account' || um_is_core_page( 'account' )) {
							...
							$output .= '<div class="form-group1 um-field-area">';
						...
						$output .= '<span class="input-icon"><i class="fa"><img src="'.get_template_directory_uri().'/assets/images/icon-pass.png" alt=""></i></span>';
						...
						if ($this->set_mode != 'login' && isset( $data['force_confirm_pass'] ) && $data['force_confirm_pass'] == 1) {
							...
							$output .= '<input class="form-control ' . $this->get_class( $key, $data ) . '" type="' . $input . '" name="' . $key . UM()->form()->form_suffix . '" id="' . $key . UM()->form()->form_suffix . '" value="' . $this->field_value( $key, $default, $data ) . '" placeholder=" Confirm ' . $placeholder . '" data-validate="' . $validate . '" data-key="' . $key . '" />
						    ...
						    $output .= '<input type="text" id="refid" name="refid" />';		
							$output .= '</div>';
				...
				case 'image':
					...
					if ($this->field_value( $key, $default, $data )) {
						if ( ! in_array( $key, array( 'profile_photo', 'cover_photo' ) ) ) {
							...
							$img = '<img  class=" img_' . $crop_data . '" src="' . $imgValue . '" alt="" />';
						} else {
							$img = '';
						}
						...
						$output .= '<div class="um-single-image-preview ' . $crop_class . '" data-crop="' . $crop_data . '" data-key="' . $key . '">
                                ...
                                <img id=""  class=" img_' . $crop_data . '" src="" alt="" />
					...
					$output .= '<div class="um-modal-header"> ' . $modal_label . ' <a type="button" class="um-modal-btn alt" data-action="um_remove_modal"> <img src="'.get_template_directory_uri().'/assets/images/Shape-1.png" alt="Shape-1"> </a></div>';
					...
					$output .= '<div class="um-single-image-preview ' . $crop_class . ' ' . $crop_data . '_cls"  data-crop="' . $crop_data . '" data-ratio="' . $ratio . '" data-min_width="' . $min_width . '" data-min_height="' . $min_height . '" data-coord=""><img src="" class="cropper-12 image_' . $crop_data . ' " alt="" /><div class="um-clear"></div></div><div class="um-clear"></div>';
					...
					$output .= '<div id="upload-preview" class="mt30 mb35"></div>';

					$output .= '<div class="um-modal-footer">
                                    <div class="um-modal-right">
                                       
                                        <a href="#" class="um-modal-btn alt cncelImg"> ' . __( 'Cancel', 'ultimate-member' ) . '</a>

                                         <a href="#" style="display:none;" class="um-modal-btn um-finish-upload image disabled" data-key="' . $key . '" data-change="' . __( 'Change photo', 'ultimate-member' ) . '" data-processing="' . __( 'Processing...', 'ultimate-member' ) . '"> ' . __( 'Apply', 'ultimate-member' ) . '</a>
                                    </div>
