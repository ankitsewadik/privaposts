		...
		$overlay = '<span class="um-cover-overlay">
				<span class="um-cover-overlay-s">
					<ins>
						...
						<span class="um-cover-overlay-t" style="display:block;">' . __( 'Change your cover photo', 'ultimate-member' ) . '</span>
						<span class="um-cover-overlay-size">' . __( '(1600x400)', 'ultimate-member' ) . '</span>
					</ins>
				</span>
			</span>';
...
function um_profile_header( $args ) {
	...
	<div class="um-header<?php echo $classes; ?>">
		...
		<div class="um-profile-photo" data-user_id="<?php echo um_profile_id(); ?>">
			...
			<a href="javascript:void(0);" class="um-profile-photo-img"
			   title="<?php echo um_user( 'display_name' ); ?>">
			   <?php echo $overlay . get_avatar( um_user( 'ID' ), $default_size ); ?></a>
			...
			if (!isset( UM()->user()->cannot_edit )) {
				...
				} else if (UM()->fields()->editing == false) {
