...
class UM_Messaging_API {
	...
	function __construct() {
        ...
        add_action( 'wp_ajax_um_messaging_unread', array( $this->api(), 'ajax_messaging_unread' ) );
        add_action( 'wp_ajax_um_multimessaging_send', array( $this->api(), 'ajax_multimessaging_send' ) );
    }
