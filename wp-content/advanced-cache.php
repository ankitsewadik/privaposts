...
$rocket_cache_path  = '/var/www/html/privaposts/wp-content/cache/wp-rocket/';
$rocket_config_path = '/var/www/html/privaposts/wp-content/wp-rocket-config/';

if ( file_exists( '/var/www/html/privaposts/wp-content/plugins/wp-rocket/inc/front/process.php' ) && version_compare( phpversion(), '5.4' ) >= 0 ) {

	spl_autoload_register( function( $class ) {
		$rocket_path    = '/var/www/html/privaposts/wp-content/plugins/wp-rocket/';
		$rocket_classes = [
	...
	include '/var/www/html/privaposts/wp-content/plugins/wp-rocket/inc/front/process.php';
} else {
