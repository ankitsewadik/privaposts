...
?>
 ...
 ?>
<div class="modal modal-sec modal-sub fade in" id="sendtip-popup" role="dialog" >
    ...
    <div class="modal-body">
     <div class="center-text"> <img src="<?php echo get_template_directory_uri(); ?>/assets/images/Forma-1.png" alt="Forma-1">
      ...
      <div class="btns clearfix">
       <button type="button" data-dismiss="modal" class=" btn btn-default save close">OK</button>
      </div>
     </div>
    </div>
   </div>
