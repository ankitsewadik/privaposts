        ...
        if ( is_wp_error( $user_data ) ) {
            ...
            //update_user_meta( $userid, 'um_user_profile_url_slug_user_login', $username);
              ...
              $_SESSION['message'] = '<div class="alert alert-success"><strong>Success!</strong> User name updated successfully.Please login by updated user name.</div> ';
                  ...
                  exit;
              }else if(($added_subscription_price == '' || $added_subscription_price =='0.00') && ($subscription_price!='' && $subscription_price !='0.00')){
          ...
          wp_redirect( site_url('/edit-profile/?profiletab=main&um_action=edit') );
          exit;*/
 ...
 <div class="col-md-12">
  <div class="copy-url-wrp">
     <div class="copy-url">
      ...
      <button onclick="Copyurl()" class="btn btn-default">Copy Link</button>
     </div>
    </div>
   <div class="edit-form-copy-url bx-bg-shadow">
    ...
    <div class="save-profile-pics clearfix">
     ...
     <div class="col-md-5 text-right">      
      <a href="#" class="btn btn-default btn-cncl">Cancel</a>     
      <a href="#" class="btn btn-default btn-save">Save Changes</a>     
     </div>
    </div>
   ...
   <div class="upload-img sub-prc  bx-bg-shadow clearfix">
    ...
    <div class="rt-con smal entr-price">
     ...
     <button type="submit" class="btn save-price theme-btn">Save Price</button>
  ...
  echo site_url()."/".$usernameval;
   ...
   <div class="upload-img clearfix">
    ...
    <div class="rt-con larg">
     <textarea class="form-control" rows="3" name="userbio" id="userbio" maxlength="200"><?php echo $userbio; ?></textarea>
