...
(function(factory) {
    ...
    tActions = '<div class="file-actions">\n' +
        ...
        '</div>';
    //noinspection HtmlUnknownAttribute
    tActionDelete = '<a href="javascript:void(0);" class="kv-file-remove {removeClass}" ' + 'title="remove" {dataUrl}{dataKey}><i class="fa fa-close"></i></a>\n';
   ...
   // tActionZoom = '';
    ...
    FileInput.prototype = {
        ...
        _createContainer: function() {
            var self = this,
                ...
                .attr({ "class": 'file-input fileuploadcls file-input-new' })
    ...
    $.fn.fileinputLocales.en = {
        fileSingle: 'file',
        filePlural: 'files',
        browseLabel: '<span class="img-ico"><img src="https://privaposts.vn.cisinlive.com/wp-content/themes/twentysixteen/assets/images/gal-ico.png" alt=""></span>Photo/Video',
        removeLabel: 'Remove',
